...
const HeroQuestion = ({ question, handleClick }: HeroQuestionProps) => {
  return (
    <div
      ...
      className="border drop-shadow-sm cursor-pointer hover:bg-neutral-200 hover:dark:bg-neutral-800 transition-all duration-150 text-xl space-x-2 flex rounded-lg p-3"
    >
